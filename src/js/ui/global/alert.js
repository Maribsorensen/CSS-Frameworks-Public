export function showToast(message, type = "info", duration = 3000) {
  ...
  toast.className = `flex items-center p-4 rounded-md shadow-md ${typeStyles[type]} transition-opacity duration-300 opacity-0`;
  toast.innerHTML = `
    <svg viewBox="0 0 24 24" class="w-6 h-6 mr-3 fill-current">
